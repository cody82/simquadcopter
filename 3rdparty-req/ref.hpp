#ifndef REF_INCLUDE_DEFINE
#define REF_INCLUDE_DEFINE
...
public:
    ...
    {
        if(p_ != 0 && add_ref) ref_add_ref(p_);
    }
...
#endif  // #ifndef REF_INCLUDE_DEFINE
